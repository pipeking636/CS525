...
int main() {
    ...
    // 删除测试
    console_log("开始删除测试...\n");
    // int delete_keys[] = {13, 23, 45, 11, 77, 27, 30, 40, 16, 15};
    int delete_keys[] = {13,  13,  23,  45,  77,  3,   29,  14,  11,  27, 78,  30,  40,  4,   5,   15,  16};
    ...
    // 准备更新数据
    int update_keys[] = {3, 5, 16, 6};
    int new_data_values[] = {3000, 5000, 16000, 6000};
